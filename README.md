...
The platform enables users to create, edit, and export AI-generated **DOCX** and **PPTX** files securely using a modular backend and structured storage.

<p align="center">
  <img src="https://github.com/user-attachments/assets/6b2df76b-6c52-4a21-95e9-ec2f3ed054f9" width="46%" />
  &nbsp;&nbsp;
  <img src="https://github.com/user-attachments/assets/78758a0a-c458-447a-ac32-31d891bd47c5" width="46%" />
</p>

<p align="center"><i>System Architecture (Left) • MySQL Schema Design (Right)</i></p>
...
| Component | Purpose |
|----------|---------|
| **React Frontend** | Document & PPT editing UI |
| **Auth API** | JWT login & OAuth |
| **Documents API** | Manage Word docs (`projects` + `sections`) |
| **Presentations API** | Manage slide content & PPTX export |
| **Gemini AI Model** | Generate & refine content |
| **MySQL DB** | Persistent structured storage |
...
2. User creates document/presentation  
3. AI generates slides/sections  
4. User edits & saves → stored in DB  
5. Export as **.docx** / **.pptx**

---

### ⭐ Why This Design Works

- Secure + scalable JWT-based backend  
- JSON flexibility for slide layouts  
- Version-friendly text sections for DOCX  
- Clean separation: **Content ✚ Storage ✚ Export**
