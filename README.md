...
You can directly download these example files generated by the app 👇

| File Type | Download Link |
|----------|---------------|
| 📊 **AI-Generated PPTX** | [Wonders of Nature — Presentation.pptx](https://github.com/user-attachments/files/23856230/Create.a.presentation.on.the.topic.Wonders.of.Nature.Explain.the.beauty.importance.and.key.elements.of.nature.with.clear.subtopics.Include.visuals_examples.and.highlight.how.humans.can.protect.the.environm.pptx) |
| 📄 **AI-Generated Document** | [Wonders of Nature — Document.docx](https://github.com/user-attachments/files/23856248/Wonders.of.Nature.1.docx) |

> These files were generated using the live deployed app via Gemini AI 🚀  
> Check the quality yourself — titles, bullet points & structured sections included!


---
## 🏗️ System Architecture

This system follows a **modular and secure** architecture, enabling users to generate and manage AI-powered **DOCX** and **PPTX** files from a web interface.

<p align="center">
  <img src="https://github.com/user-attachments/assets/6b2df76b-6c52-4a21-95e9-ec2f3ed054f9" width="95%" />
</p>
...
|----------|-----------------|
| **Frontend (React)** | UI for creating & editing documents and presentations |
| **Auth API** | User authentication (JWT-based), Google/GitHub OAuth |
| **Documents API** | CRUD for Word documents (`projects` + `sections`) |
| **Presentations API** | Slide generation & storage for PPTX files |
| **Dashboard API** | Fetches user items for the frontend dashboard |
| **AI Model (Gemini)** | Generates slides & content sections based on topics |
| **MySQL Database** | Persists users, documents, sections & presentations |
| **Export Services** | Converts structured content into .docx / .pptx files |

---

### 🔐 Authentication Flow

1️⃣ User signs up / logs in → Token issued  
2️⃣ Frontend includes `Authorization: Bearer <token>`  
3️⃣ Backend validates token on all secure API calls  
4️⃣ File downloads allowed without token for dev friendliness

---

### 🤖 AI Workflow

- User provides topic or partial text  
- Gemini generates draft slides / document content  
- Users refine and save updates → DB version stored  
...
✔ Separation of presentation vs. document content  
✔ JWT-secured APIs → only owner access  
✔ JSON format for flexible slide structures  
✔ Editable & version-tracked sections for DOCX  
✔ Scalable API design for future features

---

> This architecture enables a smooth **AI → Edit → Export** workflow for professional document creation.
